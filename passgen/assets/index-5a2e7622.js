...
const i = "./assets/javascript-8dac5379.svg",
  a = "./vite.svg";
function l(c) {
  const o = (t) => Math.floor(Math.random() * t),
    s = document.querySelector(".read-the-docs"),
    r =
      "qwertyuiopasdfghjklzxcvbnmQWERTYUIOPASDFGHJKLZXCVBNM1234567890!@#$%^&*()-=_+",
    e = () => {
      s.innerHTML = "";
      for (let t = 0; t < 20; t++) s.innerHTML += r[o(r.length)];
    };
